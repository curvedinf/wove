...
async def fetch_item_details(item_id: int, api_key: str):
    ...
    # The print statements are commented out to avoid flooding stdout when
    # running with a large number of items.
...
async def run_api_aggregator_example():
    ...
    # Increased to 20000 to test performance with a large number of tasks.
    item_ids = list(range(20000))
